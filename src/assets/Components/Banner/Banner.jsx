...
function Banner(){
    ...
    return(
        ...
        <div id="left" className="lg:w-1/2 md:w-1/2 md:pl-5 py-10 px-2 lg:px-5 " >
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-semibold text-purple-500">6 Months Of Experience</h2>
            <h1 className="font-sans text-3xl md:text-4xl lg:text-6xl lg: font-bold pt-5">The Best Choice For </h1>
            <h1 className="font-sans text-3xl md:text-4xl lg:text-6xl lg: font-bold"> Your Successful</h1>
            <h1 className="font-sans text-3xl md:text-4xl lg:text-6xl lg: font-bold pb-5">  Business!</h1>
             <Link to={"/about"} className=" 
             bg-gradient-to-r from-purple-500 to-[#14633c]
             px-6 py-2 rounded hover:to-purple-500">Read More</Link>
